...
<head>
    ...
    <?php include 'C:\xampp\htdocs\PJ main\connect.php';?>
            ...
            <div class="container px-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link" href="main_PO.php">หน้าดูใบสั่งซื้อ</a></li>
                        <?php } ?>
        ...
        <section class="bg-light py-5">
            <div class="container px-5">
                <div class="rounded-3 py-5 px-4 px-md-5 mb-5">
                    ...
                    <div class="col">
                        <?php include('C:\xampp\htdocs\PJ main\client\history_all.php'); ?>
                    </div>
                    <center>
