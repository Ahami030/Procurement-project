...
if (isset($_SESSION['member_id'])) {
    ...
    // คำสั่ง SQL สำหรับดึงข้อมูล ID_member จากตารางที่มีเงื่อนไขตรงกับ member_id จาก session
    $sql = "SELECT ID_member FROM images WHERE ID_member = $member_id";
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            // ถ้า session ตรงกับ ID_member ในฐานข้อมูล ให้แสดง card additionalCards
            ?>
<script>
