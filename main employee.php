...
<body class="d-flex flex-column h-100">
    ...
    <main class="flex-shrink-0">
                                ...
                                <div class="p-1">
                                    ...
                                    <div class="p-1">
                                        <div class="alert alert-primary  d-flex align-items-center m-1" role="alert">
                                            <i class="fa-solid fa-file-lines mr-2 pe-2"></i>
                                            <div>
                                        ...
                                        <div class="alert alert-warning d-flex align-items-center m-1" role="alert">
                                            <i class="fa-solid fa-triangle-exclamation mr-2 pe-2"></i>
                                            <div>
                                        ...
                                        <div class="alert alert-success d-flex align-items-center m-1" role="alert">
                                            <i class="fa-solid fa-circle-check mr-2 pe-2"></i>
                                            <div>
                            ...
                            <div class="card-body shadow">
                                ...
                                <div class="p-1">
                                    <ul class="list-group list-group-flush ">
                                        <div class="alert alert-warning d-flex align-items-center m-1" role="alert">
                                        <i class="fa-solid fa-list-ul pe-2"></i>
                                            <div>
                                                ยอดรายการใบวางบิลทั้งหมด <span class="badge bg-warning ">
                                                    <?php
                                                    ...
                                                    $sql = "SELECT COUNT(id) AS id_count FROM db_checker";
                                                    ...
                                                    if ($result->num_rows > 0) {
                                                        ...
                                                        echo "No IDs found in db_checker";
                                                    }
                                                        ...
                                                        if ($result->num_rows > 0) {
                                                            while ($row = $result->fetch_assoc()) {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a href="test/show_company_info.php?company_name=<?php echo urlencode($row["company_name"]); ?>"
                                                                            class="card-link">
        ...
        <a href="" id="openModal" class="card inner-card" data-bs-toggle="modal" data-bs-target="#exampleModal2"
